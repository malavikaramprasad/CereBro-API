class QuestionsController < ApiController
  ...
  def request_tutor
    ...
    @question.start_time = params[:start_time] if params.has_key?(:start_time) && params[:start_time].present?
    @question.end_time = params[:end_time] if params.has_key?(:end_time) && params[:end_time].present?
    @question.save
    Rails.logger.info '*********************'
